  ...
  <div class="card shadow-lg">
    ...
    <div class="card-body p-4">
      <div v-if="cajaAbierta.isOpen">
        ...
        <br />
        <label class="card-text">
          <strong>Cantidad Lavados:</strong> {{ cajaAbierta.cantidadLavados ?? 0 }}
        </label>
        <router-link class="btn btn-sm btn-success mt-2" to="/formlavado">
          <i class="fas fa-plus-circle mr-1"></i> Agregar lavado
        </router-link>
        <router-link class="btn btn-sm btn-outline-success mt-2" to="/listlavado">
          <i class="fas fa-list-ul mr-1"></i> Listado de lavados
        </router-link>
        <br />
        <br />
        <label class="card-text">
          <strong>Cantidad Ingresos:</strong> ${{ cajaAbierta.totalImporteIngresos ?? '0.00' }}
        </label>
        <router-link class="btn btn-sm btn-success mt-2" to="/formingreso">
          <i class="fas fa-plus-circle mr-1"></i> Agregar ingreso
        </router-link>
        <router-link class="btn btn-sm btn-outline-success mt-2" to="/listingreso">
        ...
        <router-link class="btn btn-sm btn-outline-success mt-2" to="/listegreso">
