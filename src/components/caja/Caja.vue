<template>
  <div class="grid grid-cols-5">
    ...
    <div class="col-span-5 md:col-span-4 py-20">
      <div v-if="cajaAbierta.isOpen" class="grid grid-flow-row gap-4">
        <!--Titulo-->
        <div class="flex justify-center min-height-auto">
          <h1
            class="text-3xl text-center font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl dark:text-white"
          >
            Bienvenido
          </h1>
        </div>
        ...
        <div class="relative overflow-x-auto md:flex justify-center">
              ...
              <table class="w-full md:w-64 text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400"
>
                <tbody>
            ...
            <!--Segundo grupo botones-->
            <div class="flex justify-center min-height-auto mt-5">
    ...
    <div class="col-span-5 md:col-span-4 p-1">
      <div class="flex justify-center align-items-center">
        <div class="grid grid-cols-1 mb-4 p-0">
          <h1
            class="mb-4 text-3xl text-center font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl dark:text-white"
          >
            Bienvenido
          </h1>
