<template>
  <div class="viewport">
    <div class="m-auto rounded-lg py-2 px-2">
      ...
      <div class="bg-emerald-300 rounded-lg overflow-hidden shadow-lg mx-auto mt-2 w-fit">
      ...
      <tr v-for="tipoServicio in tipoServicios" :key="tipoServicio.id">
        ...
        <td class="px-4 py-2 whitespace-nowrap ">
          <div class="flex space-x-2">
            <button class="text-blue-600 hover:text-blue-800 focus:outline-none " @click="editarTipoServicio(tipoServicio)">
              <i class="fas fa-edit"></i>
            </button>
            <button class="text-red-600 hover:text-red-800 focus:outline-none " @click="deleteTipoServicio(tipoServicio.id)">
