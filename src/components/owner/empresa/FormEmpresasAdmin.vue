<template>
    <div class="viewport">
      <div class="card w-max m-auto p-4">
        <div class="mb-3">
          <router-link :to="'owner/empresas'" class="text-emerald-300 hover:text-emerald-600">&lt; Volver atrás
          </router-link>
        </div>
        <h1 class="font-bold">Empresas</h1>
        <form>
          <div class="form-group">
            <label for="nombre" class="text-black">Empresa</label>
            <input type="text"
